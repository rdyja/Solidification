...
Point(9) = {0.1, 0, 0, 1};
Point(10) = {0.1, 0.1, 0, 1};
Point(11) = {0, 0.1, 0, 1};
Point(12) = {0, 0, 0.1, 1};
Point(13) = {0.1, 0, 0.1, 1};
Point(14) = {0.1, 0.1, 0.1, 1};
Point(15) = {0, 0.1, 0.1, 1};
Point(16) = {0.0, 0.2, 0.0, 1};
Point(17) = {0.2, 0.2, 0.0, 1};
Point(18) = {0.2, 0.0, 0.0, 1};
Point(19) = {0.0, 0.2, 0.2, 1};
Point(20) = {0.2, 0.2, 0.2, 1};
Point(21) = {0.0, 0.0, 0.2, 1};
Point(22) = {0.2, 0.0, 0.2, 1};
